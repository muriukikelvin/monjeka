<?php
	...
	if($ecommerce_solution_post_date == false && $ecommerce_solution_post_author == false && $ecommerce_solution_post_comment == false){
	...
	$ecommerce_solution_custom_css .='.primary-navigation a{';
		$ecommerce_solution_custom_css .='padding: '.esc_html($ecommerce_solution_menu_padding).'px;';
	$ecommerce_solution_custom_css .='}';
	...
	if($ecommerce_solution_post_featured_image == 'Color'){
		$ecommerce_solution_custom_css .='.post-color{';
			$ecommerce_solution_custom_css .='background-color: '.esc_html($ecommerce_solution_post_featured_color).';';
		$ecommerce_solution_custom_css .='}';
	}
	...
	if($ecommerce_solution_post_featured_image_dimention == 'Custom'){
		$ecommerce_solution_custom_css .='.box-image img{';
			$ecommerce_solution_custom_css .='width: '.esc_html($ecommerce_solution_post_featured_image_custom_width).'px; height: '.esc_html($ecommerce_solution_post_featured_image_custom_height).'px;';
		$ecommerce_solution_custom_css .='}';
	}
	...
	if($ecommerce_solution_post_featured_image == 'Color'){
		$ecommerce_solution_custom_css .='.post-color{';
			$ecommerce_solution_custom_css .='width: '.esc_html($ecommerce_solution_custom_post_color_width).'px; height: '.esc_html($ecommerce_solution_custom_post_color_height).'px;';
		$ecommerce_solution_custom_css .='}';
	}
