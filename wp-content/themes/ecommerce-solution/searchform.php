...
<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<label>
		...
		<input type="search" class="search-field" placeholder="<?php echo esc_attr( get_theme_mod('ecommerce_solution_search_placeholder', __('Search', 'ecommerce-solution')) ); ?>" value="<?php echo get_search_query() ?>" name="s">
	</label>
