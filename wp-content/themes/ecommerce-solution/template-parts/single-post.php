	...
	<?php if( get_theme_mod( 'ecommerce_solution_single_post_date',true) != '' || get_theme_mod( 'ecommerce_solution_single_post_author',true) != '' || get_theme_mod( 'ecommerce_solution_single_post_comment',true) != '') { ?>
		<div class="metabox">
	      	<?php if( get_theme_mod( 'ecommerce_solution_single_post_date',true) != '') { ?>
	        	<span class="entry-date"><i class="<?php echo esc_attr(get_theme_mod('ecommerce_solution_post_date_icon','far fa-calendar-alt')); ?>"></i><a href="<?php echo esc_url( get_day_link( $archive_year, $archive_month, $archive_day)); ?>"><?php echo esc_html( get_the_date() ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span><?php echo esc_html( get_theme_mod('ecommerce_solution_single_post_meta_seperator') ); ?>
	      	<?php }?>
